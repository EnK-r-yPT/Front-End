...
const Layout = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className="button fixed bottom-8 bg-[color:var(--color-primary)] shadow-lg shadow-[color:var(--main-color)] w-16 h-10 rounded-r-full flex justify-end items-center">
